	...
	config = function()
		...
		vim.api.nvim_create_autocmd("FileType", {
			...
			callback = function(args)
				...
				-- 			name = "T"
				-- 		end
				-- 		-- Neovim 会自动处理范围，我们只需要构建并执行命令
				-- 		-- 使用 vim.fn.escape 来确保名称中的特殊字符被正确处理
				...
				opts.desc = "[G]o [P]kg [O]utline (显示当前 Go 包的 Outline)"
